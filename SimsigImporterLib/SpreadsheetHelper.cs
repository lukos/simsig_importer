    ...
    public class SpreadsheetHelper
    {
        ...
        public SimSigTimetable Import(string fileName)
        {
            using (SpreadsheetDocument doc = SpreadsheetDocument.Open(fileName, false))
            {
                ...
                return tt.Timetables == null ? null : tt;
            }
        }
        ...
        private Timetable ProcessTimetableColumn(WorkbookPart wbPart, Worksheet worksheet, int workCol, int headcodeRow, int powerRow, int seedRow, int locationStartRow, int locationEndRow)
        {
            ...
            try
            {
                ...
                tt.StartTraction = GetCellValue(wbPart, worksheet, $"{workCol.ToExcelColumn()}{powerRow}");     // We will relink these after loading them all
